...
class TicketsCog(commands.Cog):
    ...
    async def ticket_panel(self, interaction: "discord.Interaction"):
        ...
        embed = discord.Embed(
            ...
            description="Если у вас возникла проблема или вопрос — нажмите кнопку ниже.",
            color=0x9B59B6
        )
        
        await interaction.response.send_message("✅ Панель тикетов успешно создана!", ephemeral=True)
        
        await interaction.channel.send(
            embed=embed, 
            view=ImprovedTicketPanelView(self.bot)
        )
...
class ImprovedTicketPanelView(View):
    ...
    async def create_ticket(self, interaction: "discord.Interaction", button: Button):
        ...
        view.add_item(ImprovedTicketCategorySelect(self.bot))
...
class ImprovedTicketControls(View):
    ...
    async def _archive_and_close(self, interaction: "discord.Interaction"):
        ...
        if cog and channel.id in cog.active_tickets:
            del cog.active_tickets[channel.id]
